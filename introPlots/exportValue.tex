% Created by tikzDevice version 0.12.3.1 on 2022-04-15 10:53:46
...
\path[fill=fillColor] (175.98,  5.50) rectangle (293.90, 30.95);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (448.07,252.94);
\definecolor{drawColor}{RGB}{248,118,109}

\path[draw=drawColor,line width= 0.6pt,line join=round] (188.43, 18.23) -- (199.99, 18.23);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (448.07,252.94);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.88] at (206.94, 15.20) {Export Value};
\end{scope}
\end{tikzpicture}
