...
* Told me to remember that we need to show how our dynamic model works better than the static EDMs. Doesn't need to be the perfect or something that exacatly repplicates the observed data. When looking at policy analysis we apply our model and compute the prices and the welfare for producer and consumer.
