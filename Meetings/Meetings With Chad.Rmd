...
* We know the animal numbers in any year. So we can compute the costs. Again look at the fed cattle and cow numbers to compute the costs. And use those animals to get the cost per pound of meat. Our costs are in dollars per head, if we know the animal type and number, we can get the cost per pound of meat. 
