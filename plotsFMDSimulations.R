...
proj_Q_P_PostFMD_OPT_5_II <- proj_Q_P_PostFMD_OPT_5_I %>% transmute(Year = Year, Ps5 = Ps, Pc5 = Pc, Sl5 = Sl, Cl5 = Cl,
                                                              mu5 = muTilde, sh5 = sh, D5 = demDollarsAfter)

proj_Q_P_PostFMD_OPT_10_II <- proj_Q_P_PostFMD_OPT_10_I %>% transmute(Year = Year,Ps10 = Ps, Pc10 = Pc, Sl10 = Sl, Cl10 = Cl,
                                                              mu10 = muTilde, sh10 = sh, D10 = demDollarsAfter) 

proj_Q_P_PostFMD_OPT_20_II <- proj_Q_P_PostFMD_OPT_20_I %>% transmute(Year = Year,Ps20 = Ps, Pc20 = Pc, Sl20 = Sl, Cl20 = Cl,
                                                              mu20 = muTilde, sh20 = sh, D20 = demDollarsAfter)

##### Merging all data frames 
proj_Q_P_PostFMD_OPT_II <- Reduce(function(...) merge(...), 
       list(proj_Q_P_PostFMD_OPT_5_II, proj_Q_P_PostFMD_OPT_10_II, proj_Q_P_PostFMD_OPT_20_II))

##### Stocks
beefINV_FORECAST_PostFMD_OPT_5_II <- beefINV_FORECAST_PostFMD_OPT_5_I %>% transmute(Year = Year, K5 = K)

beefINV_FORECAST_PostFMD_OPT_10_II <- beefINV_FORECAST_PostFMD_OPT_10_I %>% transmute(Year = Year, K10 = K)

beefINV_FORECAST_PostFMD_OPT_20_II <- beefINV_FORECAST_PostFMD_OPT_20_I %>% transmute(Year = Year, K20 = K)

beefINV_FORECAST_PostFMD_OPT_II <- Reduce(function(...) merge(...), 
                                 list(beefINV_FORECAST_PostFMD_OPT_5_II, beefINV_FORECAST_PostFMD_OPT_10_II, 
                                      beefINV_FORECAST_PostFMD_OPT_20_II))


####### Pessimistic Scenario

### Prices, Supplies and Quantity demanded
proj_Q_P_PostFMD_PES_5_II <- proj_Q_P_PostFMD_PES_5_I %>% transmute(Year = Year, Ps5 = Ps, Pc5 = Pc, Sl5 = Sl, Cl5 = Cl,
                                                                 mu5 = muTilde, sh5 = sh, D5 = demDollarsAfter)

proj_Q_P_PostFMD_PES_10_II <- proj_Q_P_PostFMD_PES_10_I %>% transmute(Year = Year,Ps10 = Ps, Pc10 = Pc, Sl10 = Sl, Cl10 = Cl,
                                                                   mu10 = muTilde, sh10 = sh, D10 = demDollarsAfter) 

proj_Q_P_PostFMD_PES_20_II <- proj_Q_P_PostFMD_PES_20_I %>% transmute(Year = Year,Ps20 = Ps, Pc20 = Pc, Sl20 = Sl, Cl20 = Cl,
                                                                   mu20 = muTilde, sh20 = sh, D20 = demDollarsAfter)

##### Merging all data frames 
proj_Q_P_PostFMD_PES_II <- Reduce(function(...) merge(...), 
                                 list(proj_Q_P_PostFMD_PES_5_II, proj_Q_P_PostFMD_PES_10_II, proj_Q_P_PostFMD_PES_20_II))

##### Stocks
beefINV_FORECAST_PostFMD_PES_5_II <- beefINV_FORECAST_PostFMD_PES_5_I %>% transmute(Year = Year, K5 = K)

beefINV_FORECAST_PostFMD_PES_10_II <- beefINV_FORECAST_PostFMD_PES_10_I %>% transmute(Year = Year, K10 = K)

beefINV_FORECAST_PostFMD_PES_20_II <- beefINV_FORECAST_PostFMD_PES_20_I %>% transmute(Year = Year, K20 = K)

beefINV_FORECAST_PostFMD_PES_II <- Reduce(function(...) merge(...), 
                                         list(beefINV_FORECAST_PostFMD_PES_5_II, beefINV_FORECAST_PostFMD_PES_10_II, 
                                              beefINV_FORECAST_PostFMD_PES_20_II))

#####################################################################################################################################
######################################################### OPTIMISTIC PLOTS ##########################################################
#####################################################################################################################################

proj_Q_P_PostFMD_OPT_II_PS_PC <- proj_Q_P_PostFMD_OPT_II %>% select(Year, Ps5, Pc5, Ps10, Pc10, Ps20, Pc20)

proj_Q_P_PostFMD_OPT_II_PS_PC[,-1] <- proj_Q_P_PostFMD_OPT_II_PS_PC[,-1] * 100

EQ_PricesCosts_OPT <- EQ_PricesCosts %>% transmute(Year = Year, PsB = psMedian * 100, PcB = pcMedian * 100)

proj_Q_P_PostFMD_OPT_II_PS_PC_B <- merge(proj_Q_P_PostFMD_OPT_II_PS_PC, EQ_PricesCosts_OPT)

proj_Q_P_PostFMD_OPT_II_PS_B <- proj_Q_P_PostFMD_OPT_II_PS_PC_B %>% select(Year, PsB, Ps5, Ps10, Ps20)

proj_Q_P_PostFMD_OPT_II_PC_B <- proj_Q_P_PostFMD_OPT_II_PS_PC_B %>% select(Year, PcB, Pc5, Pc10, Pc20)

#### The following has the percent change
proj_Q_P_PostFMD_OPT_II_PS_B_PercentChange <- proj_Q_P_PostFMD_OPT_II_PS_B %>%
  transmute(Year, Ps5Percent = (((Ps5-PsB)/PsB) * 100), Ps10Percent = (((Ps10-PsB)/PsB) * 100),
            Ps20Percent =(((Ps20-PsB)/PsB) * 100)) %>% round(3)

proj_Q_P_PostFMD_OPT_II_PC_B_PercentChange <- proj_Q_P_PostFMD_OPT_II_PC_B %>%
  transmute(Year, Pc5Percent = (((Pc5-PcB)/PcB) * 100), Pc10Percent = (((Pc10-PcB)/PcB) * 100),
            Pc20Percent =(((Pc20-PcB)/PcB) * 100)) %>% round(3)

PostFMD_OPT_II_PS_ChangePlot <- round(proj_Q_P_PostFMD_OPT_II_PS_B,3) %>% ggplot(aes(x = Year))+
  ...
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_OPT_II_PS_B$Year[1],
                                  proj_Q_P_PostFMD_OPT_II_PS_B$Year[nrow(proj_Q_P_PostFMD_OPT_II_PS_B)])))+ 
...
PostFMD_OPT_II_PS_PercentChangePlot <- proj_Q_P_PostFMD_OPT_II_PS_B_PercentChange %>% ggplot(aes(x = Year))+
  ...
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_OPT_II_PS_B_PercentChange$Year[1],
                                  proj_Q_P_PostFMD_OPT_II_PS_B_PercentChange$Year[nrow(proj_Q_P_PostFMD_OPT_II_PS_B_PercentChange)])))+ 
...
PostFMD_OPT_II_PC_ChangePlot <- round(proj_Q_P_PostFMD_OPT_II_PC_B,3) %>% ggplot(aes(x = Year))+
  ...
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_OPT_II_PC_B$Year[1],
                                  proj_Q_P_PostFMD_OPT_II_PC_B$Year[nrow(proj_Q_P_PostFMD_OPT_II_PC_B)])))+ 
  scale_y_continuous(name="Change in the cull cow prices from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt")))

PostFMD_OPT_II_PC_PercentChangePlot <- proj_Q_P_PostFMD_OPT_II_PC_B_PercentChange %>% ggplot(aes(x = Year))+
  ...
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_OPT_II_PC_B_PercentChange$Year[1],
                                  proj_Q_P_PostFMD_OPT_II_PC_B_PercentChange$Year[nrow(proj_Q_P_PostFMD_OPT_II_PC_B_PercentChange)])))+ 
...
stocks_OPT_Baseline <- merge(beefINV_FORECAST_PostFMD_OPT_II, stocks_Baseline)
...
proj_Q_P_PostFMD_OPT_II_Sl_Cl <- proj_Q_P_PostFMD_OPT_II %>% select(Year, Sl5, Cl5, Sl10, Cl10, Sl20, Cl20)

EQ_Supplies_OPT <- EQ_Supplies %>% transmute(Year = Year, SlB = slMedian, ClB = clMedian)

proj_Q_P_PostFMD_OPT_II_Sl_Cl_B <- merge(proj_Q_P_PostFMD_OPT_II_Sl_Cl, EQ_Supplies_OPT)

proj_Q_P_PostFMD_OPT_II_Sl_B <- proj_Q_P_PostFMD_OPT_II_Sl_Cl_B %>% select(Year, SlB, Sl5, Sl10, Sl20)

proj_Q_P_PostFMD_OPT_II_Cl_B <- proj_Q_P_PostFMD_OPT_II_Sl_Cl_B %>% select(Year, ClB, Cl5, Cl10, Cl20)

#### The following has the percent change of supplies
proj_Q_P_PostFMD_OPT_II_Sl_B_PercentChange <- proj_Q_P_PostFMD_OPT_II_Sl_B %>%
  transmute(Year, Sl5Percent = (((Sl5-SlB)/SlB) * 100), Sl10Percent = (((Sl10-SlB)/SlB) * 100),
            Sl20Percent =(((Sl20-SlB)/SlB) * 100)) %>% round(3)

proj_Q_P_PostFMD_OPT_II_Cl_B_PercentChange <- proj_Q_P_PostFMD_OPT_II_Cl_B %>%
  transmute(Year, Cl5Percent = (((Cl5-ClB)/ClB) * 100), Cl10Percent = (((Cl10-ClB)/ClB) * 100),
            Cl20Percent =(((Cl20-ClB)/ClB) * 100)) %>% round(3)

PostFMD_OPT_II_Sl_ChangePlot <- round(proj_Q_P_PostFMD_OPT_II_Sl_B,3) %>% ggplot(aes(x = Year))+
  ...
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_OPT_II_Sl_B$Year[1],
                                  proj_Q_P_PostFMD_OPT_II_Sl_B$Year[nrow(proj_Q_P_PostFMD_OPT_II_Sl_B)])))+ 
  scale_y_continuous(name="Change in the fed cattle supply from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt")))

PostFMD_OPT_II_Sl_PercentChangePlot <- proj_Q_P_PostFMD_OPT_II_Sl_B_PercentChange %>% ggplot(aes(x = Year))+
  ...
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_OPT_II_Sl_B_PercentChange$Year[1],
                                  proj_Q_P_PostFMD_OPT_II_Sl_B_PercentChange$Year[nrow(proj_Q_P_PostFMD_OPT_II_Sl_B_PercentChange)])))+ 
  scale_y_continuous(name="Percent change in the fed cattle supply from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt"))) + geom_hline(yintercept=0, linetype="dashed")

PostFMD_OPT_II_Cl_ChangePlot <- round(proj_Q_P_PostFMD_OPT_II_Cl_B,3) %>% ggplot(aes(x = Year))+
  ...
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_OPT_II_Cl_B$Year[1],
                                  proj_Q_P_PostFMD_OPT_II_Cl_B$Year[nrow(proj_Q_P_PostFMD_OPT_II_Cl_B)])))+ 
  scale_y_continuous(name="Change in the cull cow supply from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt")))

PostFMD_OPT_II_Cl_PercentChangePlot <- proj_Q_P_PostFMD_OPT_II_Cl_B_PercentChange %>% ggplot(aes(x = Year))+
  ...
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_OPT_II_Cl_B_PercentChange$Year[1],
                                  proj_Q_P_PostFMD_OPT_II_Cl_B_PercentChange$Year[nrow(proj_Q_P_PostFMD_OPT_II_Cl_B_PercentChange)])))+ 
...
###### MuTildes and Shares
proj_Q_P_PostFMD_OPT_MU <- proj_Q_P_PostFMD_OPT_II %>% select(Year, mu5, mu10, mu20)
...
proj_Q_P_PostFMD_OPT_SHR <- proj_Q_P_PostFMD_OPT_II %>% select(Year, sh5, sh10, sh20)
...
PostFMD_OPT_II_MU_ChangePlot <- round(proj_Q_P_PostFMD_OPT_MU_B,3) %>% ggplot(aes(x = Year))+
...
PostFMD_OPT_II_MU_PercentChangePlot <- proj_Q_P_PostFMD_OPT_MU_PercentChange %>% ggplot(aes(x = Year))+
...
PostFMD_OPT_II_SHR_ChangePlot <- round(proj_Q_P_PostFMD_OPT_SHR_B,3) %>% ggplot(aes(x = Year))+
...
PostFMD_OPT_II_SHR_PercentChangePlot <- proj_Q_P_PostFMD_OPT_SHR_PercentChange %>% ggplot(aes(x = Year))+
...
proj_Q_P_PostFMD_PES_II_PS_PC <- proj_Q_P_PostFMD_PES_II %>% select(Year, Ps5, Pc5, Ps10, Pc10, Ps20, Pc20)

proj_Q_P_PostFMD_PES_II_PS_PC[,-1] <- proj_Q_P_PostFMD_PES_II_PS_PC[,-1] * 100

EQ_PricesCosts_PES <- EQ_PricesCosts %>% transmute(Year = Year, PsB = psMedian * 100, PcB = pcMedian * 100)

proj_Q_P_PostFMD_PES_II_PS_PC_B <- merge(proj_Q_P_PostFMD_PES_II_PS_PC, EQ_PricesCosts_PES)

proj_Q_P_PostFMD_PES_II_PS_B <- proj_Q_P_PostFMD_PES_II_PS_PC_B %>% select(Year, PsB, Ps5, Ps10, Ps20)

proj_Q_P_PostFMD_PES_II_PC_B <- proj_Q_P_PostFMD_PES_II_PS_PC_B %>% select(Year, PcB, Pc5, Pc10, Pc20)

#### The following has the percent change
proj_Q_P_PostFMD_PES_II_PS_B_PercentChange <- proj_Q_P_PostFMD_PES_II_PS_B %>%
  transmute(Year, Ps5Percent = (((Ps5-PsB)/PsB) * 100), Ps10Percent = (((Ps10-PsB)/PsB) * 100),
            Ps20Percent =(((Ps20-PsB)/PsB) * 100)) %>% round(3)

proj_Q_P_PostFMD_PES_II_PC_B_PercentChange <- proj_Q_P_PostFMD_PES_II_PC_B %>%
  transmute(Year, Pc5Percent = (((Pc5-PcB)/PcB) * 100), Pc10Percent = (((Pc10-PcB)/PcB) * 100),
            Pc20Percent =(((Pc20-PcB)/PcB) * 100)) %>% round(3)

PostFMD_PES_II_PS_ChangePlot <- round(proj_Q_P_PostFMD_PES_II_PS_B,3) %>% ggplot(aes(x = Year))+
  geom_line(aes(y = PsB, color="Baseline")) +
  geom_point(aes(y = PsB, color = "Baseline")) +
  geom_line(aes(y = Ps5, color="5% Depop")) +
  geom_point(aes(y = Ps5, color = "5% Depop")) +
  ...
  geom_point(aes(y = Ps20, color="20% Depop")) +
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_PES_II_PS_B$Year[1],
                                  proj_Q_P_PostFMD_PES_II_PS_B$Year[nrow(proj_Q_P_PostFMD_PES_II_PS_B)])))+ 
  scale_y_continuous(name="Change in the fed cattle prices from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt")))

PostFMD_PES_II_PS_PercentChangePlot <- proj_Q_P_PostFMD_PES_II_PS_B_PercentChange %>% ggplot(aes(x = Year))+
  geom_line(aes(y = Ps5Percent, color="5% Depop")) +
  geom_point(aes(y = Ps5Percent, color = "5% Depop")) +
  geom_line(aes(y = Ps10Percent, color="10% Depop")) +
  geom_point(aes(y = Ps10Percent, color="10% Depop")) +
  ...
  geom_point(aes(y = Ps20Percent, color="20% Depop")) +
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_PES_II_PS_B_PercentChange$Year[1],
                                  proj_Q_P_PostFMD_PES_II_PS_B_PercentChange$Year[nrow(proj_Q_P_PostFMD_PES_II_PS_B_PercentChange)])))+ 
  scale_y_continuous(name="Percent change in the fed cattle prices from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt"))) + geom_hline(yintercept=0, linetype="dashed")

PostFMD_PES_II_PC_ChangePlot <- round(proj_Q_P_PostFMD_PES_II_PC_B,3) %>% ggplot(aes(x = Year))+
  geom_line(aes(y = PcB, color="Baseline")) +
  geom_point(aes(y = PcB, color = "Baseline")) +
  geom_line(aes(y = Pc5, color="5% Depop")) +
  geom_point(aes(y = Pc5, color = "5% Depop")) +
  ...
  geom_point(aes(y = Pc20, color="20% Depop")) +
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_PES_II_PC_B$Year[1],
                                  proj_Q_P_PostFMD_PES_II_PC_B$Year[nrow(proj_Q_P_PostFMD_PES_II_PC_B)])))+ 
  scale_y_continuous(name="Change in the cull cow prices from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt")))

PostFMD_PES_II_PC_PercentChangePlot <- proj_Q_P_PostFMD_PES_II_PC_B_PercentChange %>% ggplot(aes(x = Year))+
  geom_line(aes(y = Pc5Percent, color="5% Depop")) +
  geom_point(aes(y = Pc5Percent, color = "5% Depop")) +
  geom_line(aes(y = Pc10Percent, color="10% Depop")) +
  geom_point(aes(y = Pc10Percent, color="10% Depop")) +
  ...
  geom_point(aes(y = Pc20Percent, color="20% Depop")) +
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_PES_II_PC_B_PercentChange$Year[1],
                                  proj_Q_P_PostFMD_PES_II_PC_B_PercentChange$Year[nrow(proj_Q_P_PostFMD_PES_II_PC_B_PercentChange)])))+ 
  scale_y_continuous(name="Percent change in the cull cow prices from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt"))) + geom_hline(yintercept=0, linetype="dashed")
...
stocks_Baseline <- Stock %>% filter(Year >= 2010) %>% transmute(Year, KB = K)
stocks_PES_Baseline <- merge(beefINV_FORECAST_PostFMD_PES_II, stocks_Baseline)
...
proj_Q_P_PostFMD_PES_II_Sl_Cl <- proj_Q_P_PostFMD_PES_II %>% select(Year, Sl5, Cl5, Sl10, Cl10, Sl20, Cl20)

EQ_Supplies_PES <- EQ_Supplies %>% transmute(Year = Year, SlB = slMedian, ClB = clMedian)

proj_Q_P_PostFMD_PES_II_Sl_Cl_B <- merge(proj_Q_P_PostFMD_PES_II_Sl_Cl, EQ_Supplies_PES)

proj_Q_P_PostFMD_PES_II_Sl_B <- proj_Q_P_PostFMD_PES_II_Sl_Cl_B %>% select(Year, SlB, Sl5, Sl10, Sl20)

proj_Q_P_PostFMD_PES_II_Cl_B <- proj_Q_P_PostFMD_PES_II_Sl_Cl_B %>% select(Year, ClB, Cl5, Cl10, Cl20)

#### The following has the percent change of supplies
proj_Q_P_PostFMD_PES_II_Sl_B_PercentChange <- proj_Q_P_PostFMD_PES_II_Sl_B %>%
  transmute(Year, Sl5Percent = (((Sl5-SlB)/SlB) * 100), Sl10Percent = (((Sl10-SlB)/SlB) * 100),
            Sl20Percent =(((Sl20-SlB)/SlB) * 100)) %>% round(3)

proj_Q_P_PostFMD_PES_II_Cl_B_PercentChange <- proj_Q_P_PostFMD_PES_II_Cl_B %>%
  transmute(Year, Cl5Percent = (((Cl5-ClB)/ClB) * 100), Cl10Percent = (((Cl10-ClB)/ClB) * 100),
            Cl20Percent =(((Cl20-ClB)/ClB) * 100)) %>% round(3)

PostFMD_PES_II_Sl_ChangePlot <- round(proj_Q_P_PostFMD_PES_II_Sl_B,3) %>% ggplot(aes(x = Year))+
  geom_line(aes(y = SlB, color="Baseline")) +
  geom_point(aes(y = SlB, color = "Baseline")) +
  geom_line(aes(y = Sl5, color="5% Depop")) +
  geom_point(aes(y = Sl5, color = "5% Depop")) +
  ...
  geom_point(aes(y = Sl20, color="20% Depop")) +
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_PES_II_Sl_B$Year[1],
                                  proj_Q_P_PostFMD_PES_II_Sl_B$Year[nrow(proj_Q_P_PostFMD_PES_II_Sl_B)])))+ 
  scale_y_continuous(name="Change in the fed cattle supply from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt")))
...
PostFMD_PES_II_Sl_PercentChangePlot <- proj_Q_P_PostFMD_PES_II_Sl_B_PercentChange %>% ggplot(aes(x = Year))+
  geom_line(aes(y = Sl5Percent, color="5% Depop")) +
  geom_point(aes(y = Sl5Percent, color = "5% Depop")) +
  geom_line(aes(y = Sl10Percent, color="10% Depop")) +
  geom_point(aes(y = Sl10Percent, color="10% Depop")) +
  ...
  geom_point(aes(y = Sl20Percent, color="20% Depop")) +
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_PES_II_Sl_B_PercentChange$Year[1],
                                  proj_Q_P_PostFMD_PES_II_Sl_B_PercentChange$Year[nrow(proj_Q_P_PostFMD_PES_II_Sl_B_PercentChange)])))+ 
  scale_y_continuous(name="Percent change in the fed cattle supply from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt"))) + geom_hline(yintercept=0, linetype="dashed")
...
PostFMD_PES_II_Cl_ChangePlot <- round(proj_Q_P_PostFMD_PES_II_Cl_B,3) %>% ggplot(aes(x = Year))+
  geom_line(aes(y = ClB, color="Baseline")) +
  geom_point(aes(y = ClB, color = "Baseline")) +
  geom_line(aes(y = Cl5, color="5% Depop")) +
  geom_point(aes(y = Cl5, color = "5% Depop")) +
  ...
  geom_point(aes(y = Cl20, color="20% Depop")) +
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_PES_II_Cl_B$Year[1],
                                  proj_Q_P_PostFMD_PES_II_Cl_B$Year[nrow(proj_Q_P_PostFMD_PES_II_Cl_B)])))+ 
  scale_y_continuous(name="Change in the cull cow supply from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt")))
...
PostFMD_PES_II_Cl_PercentChangePlot <- proj_Q_P_PostFMD_PES_II_Cl_B_PercentChange %>% ggplot(aes(x = Year))+
  geom_line(aes(y = Cl5Percent, color="5% Depop")) +
  geom_point(aes(y = Cl5Percent, color = "5% Depop")) +
  geom_line(aes(y = Cl10Percent, color="10% Depop")) +
  geom_point(aes(y = Cl10Percent, color="10% Depop")) +
  ...
  geom_point(aes(y = Cl20Percent, color="20% Depop")) +
  scale_x_continuous(name="Year", 
                     breaks=c(seq(proj_Q_P_PostFMD_PES_II_Cl_B_PercentChange$Year[1],
                                  proj_Q_P_PostFMD_PES_II_Cl_B_PercentChange$Year[nrow(proj_Q_P_PostFMD_PES_II_Cl_B_PercentChange)])))+ 
  scale_y_continuous(name="Percent change in the cull cow supply from baseline")  + theme_classic() + 
  theme(legend.position="bottom", legend.box = "horizontal",text = element_text(size = 12)) +
  theme(legend.title=element_blank()) + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+ 
  theme(legend.text = element_text(margin = margin(r = 30, unit = "pt"))) + geom_hline(yintercept=0, linetype="dashed")
...
###### MuTildes and Shares
proj_Q_P_PostFMD_PES_MU <- proj_Q_P_PostFMD_PES_II %>% select(Year, mu5, mu10, mu20)
...
PostFMD_PES_II_MU_ChangePlot <- proj_Q_P_PostFMD_PES_MU_B %>% ggplot(aes(x = Year))+
  geom_line(aes(y = muB, color="Baseline")) +
  geom_point(aes(y = muB, color = "Baseline")) +
  geom_line(aes(y = mu5, color="5% Depop")) +
  geom_point(aes(y = mu5, color = "5% Depop")) +
...
PostFMD_PES_II_MU_PercentChangePlot <- proj_Q_P_PostFMD_PES_MU_PercentChange %>% ggplot(aes(x = Year))+
  geom_line(aes(y = mu5Percent, color="5% Depop")) +
  geom_point(aes(y = mu5Percent, color = "5% Depop")) +
  geom_line(aes(y = mu10Percent, color="10% Depop")) +
  geom_point(aes(y = mu10Percent, color="10% Depop")) +
...
proj_Q_P_PostFMD_PES_SHR <- proj_Q_P_PostFMD_PES_II %>% select(Year, sh5, sh10, sh20)
...
PostFMD_PES_II_SHR_ChangePlot <- proj_Q_P_PostFMD_PES_SHR_B %>% ggplot(aes(x = Year))+
  geom_line(aes(y = shB, color="Baseline")) +
  geom_point(aes(y = shB, color = "Baseline")) +
  geom_line(aes(y = sh5, color="5% Depop")) +
  geom_point(aes(y = sh5, color = "5% Depop")) +
...
PostFMD_PES_II_SHR_PercentChangePlot <- proj_Q_P_PostFMD_PES_SHR_PercentChange %>% ggplot(aes(x = Year))+
  geom_line(aes(y = sh5Percent, color="5% Depop")) +
  geom_point(aes(y = sh5Percent, color = "5% Depop")) +
  geom_line(aes(y = sh10Percent, color="10% Depop")) +
  geom_point(aes(y = sh10Percent, color="10% Depop")) +
