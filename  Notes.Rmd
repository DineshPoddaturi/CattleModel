...
###########################################################################
-->
* I see changes in the priuce and quantities with the increase in demand. When simulating the model with increase in demand we increase the demand for meat before determining the prices i.e., increase the variable A in the code (for instance with a 10 percent increase in demand increase A from demand to demand times (1.1)).
* Upon increasing trhe demand I see the price for fed cattle increased and supply went down drastically. However, the price of cull cows went down and the supply for cull cow meat increased. Just with a 10 percent increase I see the loss in producer surplus decrease.
