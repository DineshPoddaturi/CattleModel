% Created by tikzDevice version 0.12.3.1 on 2021-05-07 11:53:30
...
\definecolor{fillColor}{RGB}{105,139,105}

\path[fill=fillColor] ( 63.41,145.66) rectangle (101.01,203.10);

\path[fill=fillColor] (138.61,115.36) rectangle (176.21,203.10);

\path[fill=fillColor] (213.80, 84.70) rectangle (251.40,203.10);

\path[fill=fillColor] (289.00, 54.40) rectangle (326.60,203.10);

\path[fill=fillColor] (364.20, 38.90) rectangle (401.80,203.10);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.10] at ( 82.21,153.27) {-0.163};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.10] at (157.41,122.96) {-0.249};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.10] at (232.60, 92.31) {-0.336};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.10] at (307.80, 62.00) {-0.422};
