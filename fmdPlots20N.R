...
proj_Q_P_PostFMD_OPTI_SH_08 <- proj_Q_P_PostFMD_OPTI_08 %>% select(Year, sh5, sh10)
...
proj_Q_P_PostFMD_PESI_SH_08 <- proj_Q_P_PostFMD_PESI_08 %>% select(Year, sh5, sh10)
...
optimisticPostFMD_5_08_INV <- optimisticPostFMD_5_0831[[3]] %>% filter(Year >= 2022) %>%
  select(Year, K, k3, k4, k5, k6, k7, k8, k9, k10)

optimisticPostFMD_10_08_INV <- optimisticPostFMD_10_0831[[3]] %>% filter(Year >= 2022) %>%
  select(Year, K, k3, k4, k5, k6, k7, k8, k9, k10)
